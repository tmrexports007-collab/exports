      ...
      <div className="w-full ">
        ...
        <div className="flex flex-col lg:flex-row items-stretch min-h-150  overflow-hidden ">
            ...
            >
              ...
              <div className="relative z-20 space-y-8">
                <div className="space-y-2">
                  ...
                  <h3 className=" text-xl md:text-4xl font-black text-white lg:tracking-tight">TMR AGRO & MARINE</h3>
                ...
                <div className="space-y-6 text-white">
                  ...
                  <div className="flex flex-col items-center gap-1">
                    <p className="text-lg lg:text-3xl font-black text-white">+91 96666 54679</p>
          ...
          <motion.div
            ...
            className="w-full lg:w-1/2 p-4 lg:p-8  bg-white flex flex-col justify-center"
          >
            ...
            <form className="space-y-8" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="space-y-1 border-b border-gray-200 focus-within:border-[#468e3d] transition-colors pb-2">
                  ...
                  <input
                    ...
                    type="text"
                    placeholder="John"
                    className="w-full bg-transparent border-none outline-none placeholder:text-base text-gray-800 placeholder:text-gray-200"
                  />
                </div>

                <div className="space-y-1 border-b border-gray-200 focus-within:border-[#468e3d] transition-colors pb-2">
                  <label className="text-base font-bold text-blue-950 lg:uppercase lg:tracking-widest">Last Name</label>
                  <input
                    name="lastName"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="space-y-1 border-b border-gray-200 focus-within:border-[#468e3d] transition-colors pb-2">
                  <label className="text-base font-bold text-blue-950 lg:uppercase lg:tracking-widest">Email Address</label>
                  <input
                    name="email"
                ...
                <div className="space-y-1 border-b border-gray-200 focus-within:border-[#468e3d] transition-colors pb-2">
                  <label className="text-base font-bold text-blue-950 lg:uppercase lg:tracking-widest">Phone Number</label>
                  <input
                    name="phone"
                    ...
                    className="w-full bg-transparent border-none outline-none text-gray-800 placeholder:text-gray-200"
                  />
                </div>
              </div>

              <div className="space-y-1 border-b border-gray-200 focus-within:border-[#468e3d] transition-colors pb-2">
                <label className="text-base font-bold text-blue-950 lg:uppercase lg:tracking-widest">Share your requirement</label>
                <textarea
                  name="message"
                  ...
                  className="w-full bg-transparent border-none outline-none text-gray-800 placeholder:text-base placeholder:text-gray-200 resize-none"
                />
              </div>
